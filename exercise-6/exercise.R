...
max(husky.games.2015["combined"], na.rm = TRUE)
score.most.yards <- c(husky.games.2015["13", "uw_score"], husky.games.2015["13", "opponent_score"])
...
MostYardsScore <- function('games') {
  paste("The Huskies achieved 284 passing yards and 296 running yards, a total of 580 yards.")
